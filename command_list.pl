...
has_started:- g_read(started,0), write('The game hasn\'t started'),nl,!, fail.
...
take(_):-
	has_started, nl,
	write('The item doesn\'t exist'),nl, fail.
...
/* SAVE STATE */
save:-
	nl, write('Write the name of the save file:'), nl,
	write('> '), read(File),
	atom_concat(File, '.txt', Filetxt),
	open(Filetxt, write, Stream),
	save_all_fact(Stream),
	close(Stream), 	write('Game saved!'), nl.
